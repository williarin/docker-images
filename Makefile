...
alpine313:
	docker $(BUILDX) build $(PUSH) --no-cache $(PLATFORM) -t williarin/alpine:3.13 alpine/3.13

alpine314:
	docker $(BUILDX) build $(PUSH) --no-cache $(PLATFORM) -t williarin/alpine:3.14 alpine/3.14

alpine315:
	docker $(BUILDX) build $(PUSH) --no-cache $(PLATFORM) -t williarin/alpine:3.15 alpine/3.15

alpine316:
	docker $(BUILDX) build $(PUSH) --no-cache $(PLATFORM) -t williarin/alpine:3.16 -t williarin/alpine:latest alpine/3.16

alpineedge:
	docker $(BUILDX) build $(PUSH) --no-cache $(PLATFORM) -t williarin/alpine:edge alpine/edge
...
php7:
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.15 --build-arg PHP_VERSION=7.4 --target php -t williarin/php:7.4 php/7.4
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.15 --build-arg PHP_VERSION=7.4 --target php-dev -t williarin/php:7.4-dev php/7.4
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.15 --build-arg PHP_VERSION=7.4 --target php-fpm -t williarin/php:7.4-fpm php/7.4
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.15 --build-arg PHP_VERSION=7.4 --target php-fpm-dev -t williarin/php:7.4-fpm-dev php/7.4

php8:
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.15 --build-arg PHP_VERSION=8.0 --target php -t williarin/php:8.0 php/8.0
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.15 --build-arg PHP_VERSION=8.0 --target php-dev -t williarin/php:8.0-dev php/8.0
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.15 --build-arg PHP_VERSION=8.0 --target php-fpm -t williarin/php:8.0-fpm php/8.0
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.15 --build-arg PHP_VERSION=8.0 --target php-fpm-dev -t williarin/php:8.0-fpm-dev php/8.0

php81:
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.16 --build-arg PHP_VERSION=8.1 --target php -t williarin/php:8.1 php/8.1
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.16 --build-arg PHP_VERSION=8.1 --target php-dev -t williarin/php:8.1-dev php/8.1
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.16 --build-arg PHP_VERSION=8.1 --target php-fpm -t williarin/php:8.1-fpm php/8.1
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=3.16 --build-arg PHP_VERSION=8.1 --target php-fpm-dev -t williarin/php:8.1-fpm-dev php/8.1

php82:
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=edge --build-arg PHP_VERSION=8.2 --target php -t williarin/php:8.2 php/8.2
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=edge --build-arg PHP_VERSION=8.2 --target php-dev -t williarin/php:8.2-dev php/8.2
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=edge --build-arg PHP_VERSION=8.2 --target php-fpm -t williarin/php:8.2-fpm php/8.2
	docker $(BUILDX) build $(PUSH) $(PLATFORM) --build-arg ALPINE_VERSION=edge --build-arg PHP_VERSION=8.2 --target php-fpm-dev -t williarin/php:8.2-fpm-dev php/8.2
